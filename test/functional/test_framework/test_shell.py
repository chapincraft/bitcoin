...
class TestShell:
    """Wrapper Class for LearncoinTestFramework.

    The TestShell class extends the LearncoinTestFramework
    ...
    class __TestShell(LearncoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by LearncoinTestFramework child class.
            self.num_nodes = 1
