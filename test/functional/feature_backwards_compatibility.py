#!/usr/bin/env python3
# Copyright (c) 2018-2020 The Learncoin Core developers
...
class BackwardsCompatibilityTest(LearncoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(4)
        node_v17.assert_start_raises_init_error(["-wallet=w3_v18"], "Error: Error loading w3_v18: Wallet requires newer version of Learncoin Core")
        if self.options.descriptors:
            ...
            node_v17.assert_start_raises_init_error(["-wallet=w3"], "Error: Error loading w3: Wallet requires newer version of Learncoin Core")
        self.start_node(4)
        ...
        # Copy the 0.16 wallet to the last Learncoin Core version and open it:
        shutil.copyfile(
        ...
        # Copy the 0.17 wallet to the last Learncoin Core version and open it:
        ...
        # Copy the 0.19 wallet to the last Learncoin Core version and open it:
        shutil.copytree(
