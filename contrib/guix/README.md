# Bootstrappable Learncoin Core Builds

This directory contains the files necessary to perform bootstrappable Learncoin
Core builds.
...
- 24GB of free disk space on the partition that the Learncoin Core git repository
  resides in
...
For a Learncoin Core depends development environment, simply invoke
...
From the top of a clean Learncoin Core repository:
...
To use dongcarl's substitute server for Learncoin Core builds after having
