#!/bin/sh
# Copyright (c) 2012-2019 The Learncoin Core developers
...
GIT_TAG=""
GIT_COMMIT=""
if [ "${LEARNCOIN_GENBUILD_NO_GIT}" != "1" ] && [ -e "$(command -v git)" ] && [ "$(git rev-parse --is-inside-work-tree 2>/dev/null)" = "true" ]; then
