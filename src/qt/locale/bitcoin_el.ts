...
<context>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n ενεργές συνδέσεις στο δίκτυο Learncoin</numerusform><numerusform>%n ενεργές συνδέσεις στο δίκτυο Learncoin</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εμφάνισε το %1 βοηθητικό μήνυμα για λήψη μιας λίστας με διαθέσιμες επιλογές για Learncoin εντολές </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το %1 θα κατεβάσει και θα αποθηκεύσει ένα αντίγραφο της αλυσίδας μπλοκ Learncoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Οι πρόσφατες συναλλαγές ενδέχεται να μην είναι ακόμα ορατές και επομένως η ισορροπία του πορτοφολιού σας μπορεί να είναι εσφαλμένη. Αυτές οι πληροφορίες θα είναι σωστές όταν ολοκληρωθεί το συγχρονισμό του πορτοφολιού σας με το δίκτυο Learncoin, όπως περιγράφεται παρακάτω.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Δεν είναι δυνατή η ανάλυση του URI! Αυτό μπορεί να προκληθεί από μη έγκυρη διεύθυνση Learncoin ή παραμορφωμένες παραμέτρους URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ένα προαιρετικό μήνυμα που επισυνάπτεται στο αίτημα πληρωμής, το οποίο θα εμφανιστεί όταν το αίτημα ανοίξει. Σημείωση: Το μήνυμα δεν θα αποσταλεί με την πληρωμή μέσω του δικτύου Learncoin.</translation>
    </message>
    <message>
...
Δεν σηματοδοτεί την Aντικατάσταση-Aπό-Έξοδο, BIP-125.</translation>
    ...
    <message>
        ...
        <translation>Προειδοποίηση: Μη έγκυρη διεύθυνση Learncoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ένα μήνυμα που επισυνάφθηκε στο bitcoin: URI το οποίο θα αποθηκευτεί με τη συναλλαγή για αναφορά. Σημείωση: Αυτό το μήνυμα δεν θα σταλεί μέσω του δικτύου Learncoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
        <translation>Πληρωμή σε:</translation>
