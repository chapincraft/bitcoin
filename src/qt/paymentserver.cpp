...
const QString LEARNCOIN_IPC_PREFIX("bitcoin:");
...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        if (arg.startsWith(LEARNCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
        {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    else if (s.startsWith(LEARNCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
