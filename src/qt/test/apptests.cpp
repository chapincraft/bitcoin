...
//! Entry point for LearncoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &LearncoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for LearncoinGUI tests.
void AppTests::guiTests(LearncoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &LearncoinGUI::consoleShown, this, &AppTests::consoleTests);
