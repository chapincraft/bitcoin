...
#ifndef LEARNCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define LEARNCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Learncoin Core wallet was originally a collection of unrelated private
...
#endif // LEARNCOIN_WALLET_SCRIPTPUBKEYMAN_H
