...
#ifndef LEARNCOIN_PSBT_H
#define LEARNCOIN_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Learncoin transaction.) Returns true if the merge succeeded, false otherwise. */
