# PSBT Howto for Learncoin Core

Since Learncoin Core 0.17, an RPC interface exists for Partially Signed Learncoin
...
PSBT is an interchange format for Learncoin transactions that are not fully signed
...
#### Multisig with multiple Learncoin Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
Learncoin Core. We assume their wallets only contain the multisig funds. In case
