...
http://sourceforge.net/projects/bitcoin/files/Learncoin/bitcoin-0.5.0/
...
If you have a previously encrypted wallet.dat, the first time you run bitcoin-qt or bitcoind the wallet will be rewritten, Learncoin will
