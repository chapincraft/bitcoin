...
http://sourceforge.net/projects/bitcoin/files/Learncoin/bitcoin-0.6.0/test/
...
versions of Learncoin-Qt/bitcoind.
...
bitcoin: URIs onto the Learncoin-Qt window to start
payment.
