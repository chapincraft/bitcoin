...
http://sourceforge.net/projects/bitcoin/files/Learncoin/bitcoin-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxbitcoin or bitcoind the wallet will be rewritten, Learncoin will
