# Fuzzing Learncoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Learncoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the Learncoin Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Learncoin Core more robust.
...
with certain assembly code from Learncoin Core's code. See [developer notes on sanitizers](https://github.com/bitcoin/bitcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Learncoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Learncoin Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing Learncoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Learncoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
